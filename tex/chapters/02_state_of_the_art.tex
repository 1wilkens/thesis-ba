...
\abstract{%
This chapter describes the current state of the art in high-performance computing. The dominance of Fortran and C is explained in~\autoref{sec:State_of_the_art::Weaknesses_C_Fortran} and after that all language candidates are introduced and characterized.
}
