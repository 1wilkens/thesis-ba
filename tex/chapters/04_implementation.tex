...
Similar to Go Rust provides its own build system. As mentioned in the \hyperref[subsec:State_of_the_art::Candidates::Rust]{candidate introduction} Rust installs its own package manager \mdinline{cargo}. It functions as build system and is also capable of creating new projects.
\\
